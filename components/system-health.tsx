...
export function SystemHealth() {
  const services = [
    { name: "API Gateway", status: "Operational", color: "bg-success" },
    { name: "Auth Service", status: "Operational", color: "bg-success" },
  ...
  return (
    <Frame className="h-full">
      <FramePanel className="flex h-full flex-col gap-5 p-5 lg:p-6 overflow-hidden relative group">
        <div className="absolute top-0 right-0 w-32 h-32 bg-success/5 rounded-full blur-3xl -mr-10 -mt-10 pointer-events-none group-hover:bg-success/10 transition-colors duration-500"></div>
        ...
        <div className="flex items-center justify-between border-b border-border/20 pb-4 relative z-10">
          ...
          <div className="flex items-center gap-1.5">
            ...
            />
            <span className="text-[10px] uppercase tracking-widest text-success font-medium font-mono">
              99.98%
            </span>
          </div>
        </div>
