...
const faqs = [
  {
    q: "How do I run a custom payroll cycle?",
    a: "Navigate to the Payroll module, click 'Run Payroll' and select the 'Custom' frequency from the disbursement dropdown.",
  },
  {
    q: "Can I automate employee offboarding?",
    a: "Yes, you can configure offboarding workflows in Settings > Team > Automations to trigger exit interviews and account deactivation.",
  },
  {
    q: "Where can I find the API documentation?",
    a: "API keys and full documentation are available in the Integration hub for administrative users.",
  },
];
