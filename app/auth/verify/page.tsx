    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-3 pt-2">
          <Link href="/dashboard">
            <Button className="w-full h-10 bg-primary text-primary-foreground font-bold rounded-lg group shadow-sm">
              Verify & Continue
              <HugeiconsIcon icon={ArrowRight01Icon} size={16} className="ml-2 group-hover:translate-x-0.5 transition-transform" />
            </Button>
          </Link>
          <Link href="/auth/login" className="block">
            <Button variant="ghost" className="w-full h-9 text-[11px] font-bold text-muted-foreground/40 hover:text-foreground">
              Back to login
            </Button>
          </Link>
        </div>
