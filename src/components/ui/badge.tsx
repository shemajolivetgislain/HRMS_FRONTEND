...
const badgeVariants = cva(
  "h-5 gap-1.5 rounded-full border px-2 py-0.5 text-xs font-medium tracking-tight transition-colors inline-flex items-center justify-center w-fit whitespace-nowrap shrink-0 [&>svg]:size-3! overflow-hidden group/badge capitalize",
  {
    variants: {
      variant: {
