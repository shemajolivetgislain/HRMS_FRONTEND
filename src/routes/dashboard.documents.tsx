    ...
    <main className="flex flex-1 flex-col gap-0 overflow-hidden">
      ...
      <div className="flex flex-col gap-6 pb-12 flex-1 overflow-auto no-scrollbar px-4 lg:px-6">
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <StatCard label="Contracts" value="48 Files" icon={File02Icon} variant="primary" />
          <StatCard label="Identities" value="132 Files" icon={FolderSecurityIcon} variant="success" />
          <StatCard label="Experience" value="24 Files" icon={File02Icon} variant="info" />
          <StatCard label="Policies" value="12 Files" icon={FolderSecurityIcon} variant="accent" />
        </section>
            ...
            <FramePanel className="p-0 overflow-hidden bg-card">
              <FrameHeader className="border-b-0 pb-2">
                <div>
                  ...
                  <FrameDescription>Secure file repository with version control</FrameDescription>
                </div>
              </FrameHeader>
