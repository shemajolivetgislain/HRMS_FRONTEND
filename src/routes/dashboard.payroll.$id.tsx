							...
							<FramePanel className="p-0 overflow-hidden bg-card h-full flex flex-col">
								...
								<FrameContent className="flex-1 space-y-5 py-2">
									<LineItem
										label="Basic Salary"
										value={
											data.base ? formatCurrency(data.base) : formatCurrency(0)
										}
									/>
									<LineItem
							...
							<FramePanel className="p-0 overflow-hidden bg-card h-full flex flex-col">
								...
								<FrameContent className="flex-1 space-y-5 py-2">
									<LineItem
										...
										value={
											data.tax ? formatCurrency(data.tax) : formatCurrency(0)
										}
										negative
									/>
									<LineItem
								...
								<FrameFooter className="bg-destructive/[0.02] border-destructive/5">
									<div className="flex items-center justify-between">
										...
										<span className="text-[14px] font-bold text-destructive tabular-nums">
											{data.tax && data.deductions
												? formatCurrency(data.tax + data.deductions)
												: formatCurrency(0)}
										</span>
									</div>
								</FrameFooter>
